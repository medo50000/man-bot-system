...
//هنا اذا تبي تخلي شخص معين , يتحكم باسم البوت 

const developers = ["ID NUMBER 1 ","ID NUMBER 2"]
const adminprefix = "*";
client.on('message', message => {
  ...
  if (message.content.startsWith(adminprefix + 'ply')) {
    client.user.setGame(argresult);
      message.channel.send(`** تم تغير أسم ألبوت **`)
  } else 
  ...
  client.user.setUsername(argresult).then
      message.channel.send(`** تم تغير ألأسم بنجاح** `)
} else
if (message.content.startsWith(adminprefix + 'setavatar')) {
  client.user.setAvatar(argresult);
    message.channel.send(`** تم تغير ألصورة بنجاح **`);
}
});
...
قم بالاختيار .. :arrow_heading_down: 
			 
:earth_africa: ${prefix}public ⥨ الاوامر العامة :earth_africa:
:gear:  ${prefix}admin ⥨ اوامر الادارة :gear: 
:video_game: ${prefix}games ⥨ اوامر الالعاب :video_game:
...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = ['By D3S : ) ','*help | *invite','By D3S','*help | *invite'];
    var i = -1;
    var j = 0;
...
client.on('message', message => {
                if(message.content === prefix + "invite") {
                  ...
                  .setFooter(`Loyalty Bot `,'https://cdn.discordapp.com/icons/531147723315871744/db6998ebe0ecf5c7c457f8103512559b.jpg?size=128')
                  .setURL("https://discordapp.com/api/oauth2/authorize?client_id=547482772676280339&permissions=8&scope=bot");
                   message.channel.sendEmbed(embed);
                  }
});
